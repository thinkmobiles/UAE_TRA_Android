 ...
 */
public class CheckDomainAvailabilityRequest extends RetrofitSpiceRequest<String, TRAServicesAPI> {

    private String mCheckUrl;

    public CheckDomainAvailabilityRequest(final String _checkUrl) {
